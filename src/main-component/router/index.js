    ...
    <div className="App">
       <Router>
          <Switch>
            ...
            <Route path='/farmers-protest' component={CaseSinglePage}/>
            ...
            <Route path='/kissan-rally' component={EventPageSingle}/>
            <Route path='/shaheedi-diwas' component={EventPageSingle}/>
