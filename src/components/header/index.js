...
import Logo from '../../images/SarbatDhaBhalla.jpg'
                ...
                <div className="col-lg-8 d-lg-block d-none">
                    <nav>
                        <ul>
                            ...
                            <li><Link to="/case" title="">Projects</Link>
                                <ul>
                                    {/* <li><Link to="/case" title="">Causes</Link></li> */}
                                    <li><Link to="/farmers-protest" title="">Farmers Project</Link></li>
                                    <li><Link to="/covid-19" title="">Covid-19</Link></li>
                                    <li><Link to="/old-age-home" title="">Old Age Home</Link></li>
                                </ul>
                            </li>
                            <li><Link to="/events" title="">Upcoming Events</Link>
                                <ul>
                                    <li><Link to="/kissan-rally" title="">Kissan Rally</Link></li>
                                    <li><Link to="/shaheedi-diwas" title="">Shaheedi Diwas</Link></li>
                                </ul>
                            </li>
