...
import tm1 from '../../images/Happy1.jpeg'
import tm2 from '../../images/Jannu1.jpeg'
import tm3 from '../../images/Billa1.jpeg'
                ...
                <div className="row">
                        ...
                        <div className="wpo-team-wrap">
                            ...
                            <div className="wpo-team-content">
                                <div className="wpo-team-text-sub">
                                    <h2><Link to="/volunteer">Amarjit Ghotra</Link> </h2>
                                    <span>Volunteer</span>
                                    <ul>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12 custom-grid">
                        <div className="wpo-team-wrap">
                            ...
                            <div className="wpo-team-content">
                                <div className="wpo-team-text-sub">
                                    <h2><Link to="/volunteer">Gagandeep Singh</Link></h2>
                                    <span>Volunteer</span>
                                    <ul>
                                        <li><Link to="/volunteer"><i className="ti-facebook"></i></Link></li>
                                        <li><Link to="/volunteer"><i className="ti-twitter"></i></Link></li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12 custom-grid">
                        <div className="wpo-team-wrap">
                            ...
                            <div className="wpo-team-content">
                                <div className="wpo-team-text-sub">
                                    <h2><Link to="/volunteer">Pradeep Singh</Link></h2>
                                    <span>Volunteer</span>
                                    <ul>
                                        <li><Link to="/volunteer"><i className="ti-facebook"></i></Link></li>
                                        <li><Link to="/volunteer"><i className="ti-twitter"></i></Link></li>
